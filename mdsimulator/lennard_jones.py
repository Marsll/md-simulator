...
def lenard_jones_potential(r1, r2, r_cut=20, epsillon=1, sigma=1):
...
def all_lenard_jones_potential(ppos, nl, nbs, r_cut=20, epsillon=1, sigma=1):
    """Computes the resulting lenard jones potential of a certain distribution ppos
    with a neighbour list nl"""
    potential = 0
    for i, cell in enumerate(nl.head):
        while cell != -1:
